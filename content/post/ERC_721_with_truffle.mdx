...
> ganache-cli
> 그리고 전에 Truffle 폴더의 경로로 명령 프롬프트를 키고 다음 절 을 실행하자!truffle migrate --compile-all --network ganache\
> \
> ![](/nftBegin.png)![](/nftMigrate.gif)\
> \
> \
>
